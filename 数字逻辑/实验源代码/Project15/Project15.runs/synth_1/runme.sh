...
HD_PWD='C:/Users/thatcher/Desktop/Project15/Project15.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_Detector1101.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_Detector1101.tcl
