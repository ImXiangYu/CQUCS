...
HD_PWD='C:/Users/thatcher/Desktop/Project15/Project15.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_Detector1101.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_Detector1101.tcl -notrace
